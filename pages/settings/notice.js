...
const NoticeData = [
  {
    question: 'v2.0.6 업데이트 내역',
    date: '2026.04.19',
    answer: `
      - 앱에서 뒤로가기를 눌렀을 때 백그라운드 재생 여부를 묻는 팝업창을 없앴어요. 라디오 재생 도중 앱을 나가면 백그라운드 재생이 유지되고, 일시정지 상태에서 나가면 앱이 완전히 종료됩니다.<br/>
- 라디오 재생 중 다른 앱에서 미디어 재생이 불가능한 문제를 수정했어요.<br/>
- Android Auto 연결 해제 시 휴대전화에서 라디오가 다시 재생되는 문제를 수정했어요.<br/>
       `,
  },
  {
